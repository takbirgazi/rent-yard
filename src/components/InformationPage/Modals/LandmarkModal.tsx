...
const LandmarkModal: React.FC<ModalType> = ({ modalOpen, setModalOpen }) => {
    const parkingTime = [
        {
            id: 1,
            val: "Mile"
                ...
                <div className="py-2 px-4">
                    <div className="py-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="w-full">
                            <Label htmlFor="country-region">Landmark type<span className="text-red-500">*</span></Label>
                            <div className="border rounded-lg my-2 px-2 text-sm flex justify-between items-center text-gray-500">
                                <Input className="border-0 focus-visible:ring-0" placeholder="Museum" />
                            </div>
                        </div>
                        <div className="w-full">
                    ...
                    <div className="w-full">
                        <Label htmlFor="country-region">Landmark name<span className="text-red-500">*</span></Label>
                        <div className="border rounded-lg my-2 px-2 text-sm flex justify-between items-center text-gray-500">
